                ...
                <div class="qodef-grid-item">
                   <div id="text-2" class="widget widget_text" data-area="footer_top_area_column_1">
                      ...
                      <div class="textwidget">
                         <p>Launch and start growing your own globe-wide online community with Join Up, the perfect starting point for your amazing new platform.</p>
                      </div>
                   </div>
                   ...
                   <div class="widget qodef-friend-suggestions-logged-out">
                      ...
                      <div class="qodef-shortcode qodef-m  qodef-advanced-call-to-action" >
                         ...
                         <div class="qodef-m-button">
                            <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--filled qodef-size--small qodef-html--link" href="register.html" target="_self"  >        <span class="qodef-m-text">Register Now</span></a>    
                         </div>
                      </div>
                   </div>
                </div>
             ...
             <div class="qodef-grid-inner clear">
                <div class="qodef-grid-item">
                   <div id="text-4" class="widget widget_text" data-area="footer_bottom_area_column_1">
                      <div class="textwidget">
                         <p><a href="https://qodeinteractive.com/" target="_blank" rel="nofollow noopener">© 2021 Qode Interactive</a>, All Rights Reserved.</p>
                      </div>
                   </div>
                </div>
                <div class="qodef-grid-item">
