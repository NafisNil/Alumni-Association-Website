...
@section('title')
BAUET Alumni CSE -  {{ $notice_single->title }}
@endsection
@section('content')
    ...
    <div class="qodef-page-title qodef-m qodef-title--breadcrumbs qodef-alignment--left qodef-vertical-alignment--header-bottom">
       <div class="qodef-m-inner">
          <div class="qodef-m-content qodef-content-grid ">
             <div itemprop="breadcrumb" class="qodef-breadcrumbs"><a itemprop="url" class="qodef-breadcrumbs-link" href="https://joinup.qodeinteractive.com/"><span itemprop="title">Home</span></a><span itemprop="title" class="qodef-breadcrumbs-current">{{$notice_single->title}}</span></div>
          </div>
       </div>
    </div>
                      ...
                      <div class="qodef-e-inner">
                         <div class="qodef-e-media">
                            <div class="qodef-e-media-image">
                               <img width="1300" height="580" src="{{(!empty($notice_single->photo))?URL::to('storage/'.$notice_single->photo):URL::to('image/no_image.png')}}" class="attachment-full size-full wp-post-image" alt="{{$notice_single->title}}"  sizes="(max-width: 1300px) 100vw, 1300px" loading="eager" />					
                            </div>
                         </div>
                         <div class="qodef-e-content-holder">
                            ...
                            <div class="qodef-e-inner-right">
                               <div class="qodef-e-content">
                                  <div class="qodef-e-info qodef-info--top">
                                     <div itemprop="dateCreated" class="qodef-e-info-item qodef-e-info-date entry-date published updated">
                                        <a itemprop="url" href="https://joinup.qodeinteractive.com/2020/11/">{{$notice_single->created_at->format('d M, Y')}}</a>
                                                                ...
                                                                <div class="elementor-element elementor-element-4aa7b22 elementor-widget elementor-widget-text-editor" data-id="4aa7b22" data-element_type="widget" data-widget_type="text-editor.default">
                                                                   <div class="elementor-widget-container">
                                                                      <div class="elementor-text-editor elementor-clearfix">
                                                                         <p><span style="color: #777b81;">{!!  $notice_single->description  !!}</span></p>
                                                                      </div>
                                                                   </div>
                                                                </div>
                                                             </div>
                               ...
                               <div id="qodef-single-post-navigation" class="qodef-m">
                                @if ($notice_single->file != null)
                                <div class="qodef-m-inner">
                                    <a itemprop="url" class="qodef-m-nav qodef--prev" href="{{(!empty($notice_single->file))?URL::to('storage/'.$notice_single->file):URL::to('image/no_image.png')}}">
                                    <span class="qodef-icon-kiko kiko-double-arrow-left kikol"></span>						<span class="qodef-m-nav-label">Download</span>	</a>
                                 </div>
                                @endif
